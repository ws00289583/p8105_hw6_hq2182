...
Both required models look good. Now consider my own model.  
Due to time consuming, I choose variables that I think the most relevant to baby's birth weight, and consider two-way interaction only.
...
Comment: some extreme points exist but overall it's good.
...
From the result, get `my_mod` and plot residuals against fitted values.
